...
\phone{(011) 4255 0067}                
\email{federoasio@gmail.com}            
\extrainfo{26 años\\ Argentino - Italiano - DNI 34.239.624}
%----------------------------------------------------------------------------------------
...
\section{Experiencia}
\cventry{2015 -- Presente}{Ingeniero de Software Senior}{\textsc{Sumaprop - Oneloop Digital Agency}}{}{}{
Sumaprop es el CRM inmobiliario lider de Argentina y en plena expansión en Lationamérica.
\newline{}
Detalle de las tareas realizadas:
\begin{itemize}
\item Gestión integral de proyectos de software web. Diseño, desarrollo, puesta en marcha y mantenimiento.
\item Desarrollo de software del lado del cliente y del lado del servidor, mantenimiento de base de datos. 
\item Mantenimiento de infraestructura de servidores, servicios de DNS y CDN en la nube.
\end{itemize}}

\cventry{2014 -- Presente}{Ayudante de primera}{\textsc{Algoritmos y Programacion I, FIUBA}}{}{}{
Dictado de clases prácticas de algoritmos y programación en lenguaje C para alumnos de Ingeniería Electrónica de la Universidad de Buenos Aires.
\newline{}
Detalle de las tareas realizadas:
\begin{itemize}
\item Desarrollo de ejercicios de algoritmos, programación en lenguaje C y buenas prácticas de diseño de software.
\item Corrección de ejercicios y trabajos prácticos.
\end{itemize}}
...
\cventry{2013 -- 2015}{Ingeniero de Proyectos de Robótica Industrial}{\textsc{Tenaris}}{}{}{Global Trainee en la división Global de Automatización y Proyectos Especiales de Tenaris
\newline{}
Detalle de las tareas realizadas:
\begin{itemize}
...
\cvitem{Básico}{Java, Play Framework, Ruby, AutoCAD, Diseño PCB}
\cvitem{Intermedio}{\textsc{python}, JavaScript, jQuery, MySQL, HTML5, CSS3, Metodologías Ágiles, Linux Embebido}
...
\cvitem{2014}{Mejor egresado de la Facultad de Ingeniería de la Universidad de Buenos Aires, Academia Nacional de Ingeniería}
...
\section{Cursos}
\cvitem{2015}{Algorithms: Design and Analysis, Part II -- Coursera.org}
\cvitem{2015}{Algorithms: Design and Analysis, Part I -- Coursera.org}
\cvitem{2014}{Tenaris University Induction Camp}
\cvitem{}{- \slshape{Capacitación intensiva internacional en Procesos Productivos, Calidad, Compras, Supply Chain, Ventas y Marketing, Management, Comunicación, Administración y Finanzas.}}
...
\cvitem{2012}{Diseño de una computadora de navegación, guiado y control:Aplicación a un vehículo aéreo no tripulado. VIII Jornadas Argentinas de Robótica.}
